    ...
    return (
        <section id="about" className="py-20">
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <p className="mt-4 text-gray-700 text-balance ">
                    Hi, I'm from Haridwar, (Uttarakhand), and I completed my BCA from Dehradun.
                    ...
                    I enjoy solving real-world problems and constantly improving myself.
                    I'm currently looking for an entry-level role where I can learn, grow, and contribute to meaningful projects.</p>
